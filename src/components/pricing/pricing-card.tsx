...
export const PricingCard = (props: PricingCardProps) => {
  ...
  return (
    ...
    >
      ...
      >
        {data.title}{" "}
        {data.recommended && <Badge variant="solid">Recommended</Badge>}
      </HStack>
      <Image
        src={
          "https://www.shop-areve.com/cdn/shop/files/N4A0241_800x.jpg?v=1715713897"
        }
        alt={"test"}
        h="72"
        objectFit="cover"
      ...
      <Button colorPalette={!data.recommended ? "gray" : undefined}>
        Get Started
      </Button>
    </Stack>
  );
